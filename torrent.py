...
class Torrent:
    ...
    # Pings the tracker and updates the peer list
    ...
    # STARTS THE HANDSHAKE PROCESS WITH COROUTINES CREATED
    ...
    # TODO: revisit when this should be activated
